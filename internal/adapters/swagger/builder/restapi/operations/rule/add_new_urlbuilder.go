...
func (o *AddNewURL) Build() (*url.URL, error) {
	...
	if musrvID != "" {
		...
		return nil, errors.New("musrvId is required on AddNewURL")
	}
...
func (o *AddNewURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AddNewURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AddNewURL")
	}
