...
func (o *GetOK) Error() string {
	return fmt.Sprintf("[GET /info][%d] getOK  %+v", 200, o.Payload)
}

func (o *GetOK) GetPayload() *models.Info {
	return o.Payload
}
...
func (o *GetDefault) Error() string {
	return fmt.Sprintf("[GET /info][%d] get default  %+v", o._statusCode, o.Payload)
}
